...
"use strict";
Object.defineProperty(exports, "__esModule", ({value: true}));// src/utils.ts
var plus100ms = (milliseconds) => {
  return parseInt(milliseconds, 10) + 100;
};



exports.plus100ms = plus100ms;
...
var _chunkMR745NIAjs = __nccwpck_require__(359);

// src/main.ts
var _core = __nccwpck_require__(733); var core = _interopRequireWildcard(_core);
var main = async () => {
  const ms = core.getInput("milliseconds");
  core.debug(`Waiting ${ms} milliseconds ...`);
  core.debug((/* @__PURE__ */ new Date()).toTimeString());
  await new Promise((resolve) => setTimeout(resolve, _chunkMR745NIAjs.plus100ms.call(void 0, ms)));
  core.debug((/* @__PURE__ */ new Date()).toTimeString());
